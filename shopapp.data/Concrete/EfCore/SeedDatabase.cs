...
namespace shopapp.data.Concrete.EfCore
{
    public static class SeedDatabase
    {
        ...
        public static Product[] Products ={
            ...
            new Product() { Name = "Samsung S6",Url="samsung-s6", Price = 3000, ImageUrl = "2.jpg",Description="İyi telefon",IsApproved=true},
            new Product() { Name = "Samsung S7",Url="samsung-s7", Price = 4000, ImageUrl = "3.jpg",Description="İyi telefon",IsApproved=false},
            new Product() { Name = "Samsung S8",Url="samsung-s8", Price = 5000, ImageUrl = "4.jpg",Description="İyi telefon",IsApproved=true},
            new Product() { Name = "Samsung S9",Url="samsung-s9", Price = 6000, ImageUrl = "5.jpg",Description="İyi telefon",IsApproved=true},
            new Product() { Name = "Samsung S10",Url="samsung-s10", Price = 7000, ImageUrl = "6.jpg",Description="İyi telefon",IsApproved=true}
        };
